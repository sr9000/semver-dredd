...
absent the built-in :class:`~snapshot.models.NormalizedSnapshot` is used
as a fallback (backward compatibility with schema v2 files).

Typical usage::

    from snapshot.registry import default_registry, load_snapshot
...
class SnapshotRegistry:
    ...
    def load_yaml_str(self, yaml_str: str) -> Any:
        ...
        :class:`~snapshot.models.NormalizedSnapshot`.
        """
...
def _ensure_builtins_registered() -> None:
    ...
    from snapshot.models import NormalizedSnapshot, NORMALIZED_SNAPSHOT_TYPE_ID
